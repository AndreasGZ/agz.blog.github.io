...
$settings = $objBenutzer->settings;
$weitere = $objBenutzer->weitere;
$admin = $objBenutzer->admin;
$redakteur = $objBenutzer->redakteur;
...
<html lang="de">
    ...
    <main>
      <div class="haupt"><h1>Dies ist ein neuer Beitrag</h1>
<p>Hallo liebe Leute</p></div>
      <div class="haupt"><form action="./beitragArtikel2.php" method="post">
                <button type="submit" name="loeschenbtn" value="beitragArtikel4">Beitrag löschen</button></div>
    </main>
